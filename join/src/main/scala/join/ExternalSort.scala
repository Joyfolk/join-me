...
object ExternalSort {
  ...
  def sort[H](source: H, target: H)(implicit dataIO: DataIO[H],
                                    oracle: Oracle): Unit = {
  ...
  private[join] def joinSort[H](
    parts: IndexedSeq[DataReader[H]],
    output: DataWriter[H, Data]
  ...
  private[this] def dumpHeap[H](
    heap: mutable.PriorityQueue[Data]
  )(implicit dataIO: DataIO[H]): DataWriter[H, Data] = {
  ...
  private[join] def splitSort[H](source: H)(
    implicit dataIO: DataIO[H],
    oracle: Oracle,
    ord: Ordering[Data]
  ): IndexedSeq[DataReader[H]] = {
